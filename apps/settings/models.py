...
class TersusDevice(models.Model):
    ...
    battery_level = models.CharField(max_length=50, blank=True, null=True)
    ip_address = models.CharField(max_length=100, blank=True, null=True)
    latitude = models.FloatField(null=True, blank=True)
    longitude = models.FloatField(null=True, blank=True)
    elevation = models.FloatField(null=True, blank=True)
    horizontal_accuracy = models.CharField(max_length=50, blank=True, null=True)
    vertical_accuracy = models.CharField(max_length=50, blank=True, null=True)
    coordinate_system = models.CharField(max_length=100, default='WGS84 / Minna Datum UTM Zone 31N')
    satellites_tracked = models.IntegerField(null=True, blank=True)
    rtk_fix_status = models.CharField(max_length=50, blank=True, null=True)
...
class IntegrationLog(models.Model):
    ...
    payload_size = models.CharField(max_length=50, blank=True, null=True)
